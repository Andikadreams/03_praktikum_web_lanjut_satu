                    ...
                    <ul id="nav4" class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        ...
                        <ul class="sub-menu collapse" id="sub-nav2">
                          ...
                          <li><a href="/list/testing">Blog Single Page</a></li>
    ...
    <footer class="footer footer-style-4 footer-dark">
      <div class="container">
        ...
        <div class="copyright-wrapper">
          <p>Design and Developed by Andika Ainur Wibowo <a href="https://Polinema.ac.id" rel="nofollow" target="_blank">Polinema</a> Built-with <a href="https://rebrand.ly/ud-lindy" rel="nofollow" target="_blank">Lindy UI Kit</a></p>        </div>
      </div>
    </footer>
